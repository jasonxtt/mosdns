...
fn checked_in_header_matches_abi_constants_and_entrypoints() {
    ...
    for expected in [
        ...
        "MOSDNS_QUERY_CAPABILITY_SNAPSHOT",
        "MOSDNS_QUERY_CAPABILITY_INSPECT",
        ...
        "MosdnsCacheStatus query_snapshot_create(",
        "MosdnsCacheStatus query_snapshot_required_len(",
        "MosdnsCacheStatus query_snapshot_inspect(",
