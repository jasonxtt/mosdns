...
pub use quic_reuse::{
    Doh3ReuseUpstream, DoqReuseUpstream, EntryHealth, EntryObservation, EntryPhase, EntryRecord,
    EntryTerminal, ExchangeRegistration, H3ErrorObservation, H3ErrorShape,
