#!/usr/bin/env python3
"""Prospective M3 controls, optionally its fixed first W1 gate."""
...
if __name__ == '__main__':
    try:
        ...
        if len(sys.argv) == 3 and sys.argv[2] == '--w1':
            ...
            raise ValueError('usage: qualify-m3-controls.py ROOT [--w1]')
        result = gate.qualify(Path(sys.argv[1]), groups, 'm3')
