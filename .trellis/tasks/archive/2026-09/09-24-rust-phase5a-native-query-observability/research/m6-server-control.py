...
INPUT = BASE / 'measurement-v6'
RESULTS = BASE / 'results-m6-server'
...
def main():
    ...
    if root.parent != RESULTS or not re.fullmatch(r'm6-[a-z0-9_-]+', root.name):
        raise ValueError('result must be a fresh owned M6 server session')
